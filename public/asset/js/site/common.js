...
var messages = {
  ...
  E001: (params) => `${params} is required field.`,
  E004: 'Please enter your email address correctly.',
  E006: (params) => `The file size limit ${params} has been exceeded.`,
  E007: (params) => `File extension is incorrect. Please use ${params}.`,
  E010: 'Email or Password incorrect.',
  E012: (paramsFisrt, paramsSecond) => `${paramsFisrt} format is not correct. Please enter ${paramsSecond} only.`,
  I005: 'There is no result.',
  I018: (params) => `Are you sure you want to delete the record with id ${params}?`,
  E002: (paramsFisrt, paramsSecond, paramsThird) => `${paramsFisrt} must be less than ${paramsSecond} characters. (Currently ${paramsThird} characters)`,
  E011: 'Re-password is not the same as Password.',
  E009: (params)=> `${params} is duplicated.`,
  E014: 'Save failed.'
}
